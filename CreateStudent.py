...
"")
        ...
        self.promo = QtWidgets.QLineEdit(self.widget_3)
        self.promo.setMaximumSize(QtCore.QSize(170, 16777215))
        self.promo.setStyleSheet("border: 1px solid #ABABAB;\n"
"border-radius:    4px;\n"
"padding: 12px;\n"
"font-size: 14px;")
        self.promo.setObjectName("promo")
        self.gridLayout.addWidget(self.promo, 10, 0, 1, 1)
        self.groupe = QtWidgets.QLineEdit(self.widget_3)
        self.groupe.setStyleSheet("border: 1px solid #ABABAB;\n"
"border-radius:    4px;\n"
"padding: 12px;\n"
"font-size: 14px;")
...
"}")
    ...
    def retranslateUi(self, CreateStudent):
        ...
        self.promo.setPlaceholderText(_translate("CreateStudent", "Promo"))
        self.groupe.setPlaceholderText(_translate("CreateStudent", "Groupe"))
import resources_rc
